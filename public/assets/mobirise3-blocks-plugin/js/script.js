    ...
    initCountdown = function() {
        a(".countdown:not(.countdown-inited)").each(function() {
            a(this).addClass("countdown-inited").countdown(a(this).attr("data-end"), function(b) {
                a(this).html(b.strftime('<div class="row"><div class="col-xs-3 col-sm-3"><span class="number-wrap"><span class="number">%D</span><span class="period">Dias</span><div class="bottom1"></div><div class="bottom2"></div><span class="dot">:</span></span></div><div class="col-xs-3 col-sm-3"><span class="number-wrap"><span class="number">%H</span><span class="period">Horas</span><div class="bottom1"></div><div class="bottom2"></div><span class="dot">:</span></span></div><div class="col-xs-3 col-sm-3"><span class="number-wrap"><span class="number">%M</span><span class="period">Minutos</span><div class="bottom1"></div><div class="bottom2"></div><span class="dot">:</span></span></div><div class="col-xs-3 col-sm-3"><span class="number-wrap"><span class="number">%S</span><span class="period">Segundos</span><div class="bottom1"></div><div class="bottom2"></div></span></div></div>'))
            })
        });
        a(".countdown:not(.countdown-inited)").each(function() {
